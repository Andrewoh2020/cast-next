...
// Exact original prompt from March 27th (commit 0dc2767)
...
console.log('Generating with exact March 27th original prompt via Kie.ai...');
...
while (Date.now() - start < 120_000) {
  ...
  if (state === 'success') {
    ...
    const filepath = join(process.env.HOME, 'Downloads', 'test-original-march27-prompt.jpg');
