            ...
            <div className="space-y-6 mb-16">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">Explore 100+ photorealistic AI characters filtered by age, ethnicity, build, and style. Or create a custom AI character from a text description.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
