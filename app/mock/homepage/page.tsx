...
export const metadata = {
  title: 'Homepage Preview: Export Reel — Cast',
  robots: { index: false, follow: false },
};

// Mirrors app/page.tsx exactly, but swaps HeroB2 to the export-reel
// variant so you can preview the full homepage end-to-end before
// flipping production.
export default function HomepageMockPage() {
  return (
    <main>
